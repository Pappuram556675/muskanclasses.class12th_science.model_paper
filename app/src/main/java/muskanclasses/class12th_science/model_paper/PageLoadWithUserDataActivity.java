...
public class PageLoadWithUserDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_load_with_user_data);
...
// Enable cookies
        ...
        String muskan = getIntent().getStringExtra("url");
        Log.e("pujaaaaaaaaaa", muskan);
    ...
    private void open_video_tab(String message) {
        ...
        if (rewardedAd!=null){
            ...
            rewardedAd.show(PageLoadWithUserDataActivity.this, new OnUserEarnedRewardListener() {
                @Override
